...
export async function getAniDBCalendar(showAll= false, numberOfDays = 1,  ){
  try {
    const { data } = await api.get(`/api/v3/Dashboard/AniDBCalendar?numberOfDays=${numberOfDays}&showAll=${showAll}`);
